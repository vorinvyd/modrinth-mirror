...
export default function Logo() {
  ...
  return (
    <Link href="/" className="flex items-center gap-2 md:gap-3 group flex-shrink-0 relative">
      ...
      />
      <span className="text-lg md:text-xl font-bold bg-gradient-to-r from-modrinth-green to-modrinth-green-light bg-clip-text text-transparent hidden sm:block group-hover:from-modrinth-green-light group-hover:to-modrinth-green transition-all select-none">Modrinth</span>
